...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("The reference to the action to open the interface for this controller.")]
        InputActionReference m_InterfaceModeActivate;
        ...
        void SetupInteractorEvents()
        {
            ...
            var interfaceModeAktivateAction = GetInputAction(m_InterfaceModeActivate);
            if (interfaceModeAktivateAction != null)
			{
                interfaceModeAktivateAction.performed += ToggleInterface;
                //interfaceModeAktivateAction.canceled += CancelInterface;
			}                
        ...
        void ToggleInterface(InputAction.CallbackContext context)
		{
            if (m_RayInteractor != null)
			{
                if (m_Interfacing == false)
				{
        ...
        void CancelInterface(InputAction.CallbackContext context)
		{
            if (m_RayInteractor != null && m_Interfacing == true)
            {
                m_RayInteractor.gameObject.SetActive(false);
                m_Interfacing = false;
            }
        ...
        protected void OnEnable()
        {
            ...
            if (m_RayInteractor.gameObject.activeSelf)
                m_RayInteractor.gameObject.SetActive(false);
